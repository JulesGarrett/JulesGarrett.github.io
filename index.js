async function graph1(){
  ...
  d3.csv("daily.csv", function(error, data) {
    ...
    svg.append("text").attr("x", width/2+150).attr("y", 10).text("Cases").style("font-size", "15px").attr("alignment-baseline","middle")
    svg.append("text").attr("x", width/2-50).attr("y", 10).text("Deaths").style("font-size", "15px").attr("alignment-baseline","middle")
